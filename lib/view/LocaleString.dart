  ...
  Map<String, Map<String, String>> get keys =>
      {
        ...
        'de_DE': {
          ...
          'stamina' : 'ausdauer',
          'fun' : 'spaß',
          'core stability' : 'stabilität',
          'relax' : 'entspannung',
          'minutes' : 'Minuten',
          'Please enter a name' : 'Bitte geben Sie einen Namen ein',
          'Enter name for course' : 'Geben Sie einen Kursnamen ein',
          'Please enter an instructor' : 'Bitte geben Sie einen Trainernamen ein',
